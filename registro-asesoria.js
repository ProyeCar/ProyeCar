...
(function () {
    ...
    function asegurarEstilosDashboardsResponsive() {
        ...
        style.textContent = '@media (max-width:480px){'
            ...
            + '.ra-admin-dash-item{display:block!important;}'
            + '.ra-admin-dash-item>div{width:100%;box-sizing:border-box;}'
            + '.ra-dash-card-header{display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:nowrap;min-width:0;}'
            + '.ra-dash-card-header .ra-dash-professional{min-width:0;overflow-wrap:normal;word-break:normal;}'
            ...
            + '.ra-dash-meta .ra-dash-info{min-width:0;overflow-wrap:normal;word-break:normal;}'
    ...
    function fechaInspeccionDashboard(d) {
        return d && (d.fecha_inspeccion || d.fechaInspeccion || d.fecha_inspeccion_campo || d.fecha || '') || '';
    }

    function fechaGeneracionDashboard(d) {
        var valor = d && (d.actualizado_en || d.creado_en || '');
